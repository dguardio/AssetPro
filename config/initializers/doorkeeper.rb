...
Doorkeeper.configure do
  ...
  # Enable client credentials (for RFID readers)
  client_credentials :from_basic, :from_params
  ...
  access_token_methods do |token, context|
    {
      # Add any custom fields you want in the token response
      created_at: token.created_at.to_i,
      expires_in: token.expires_in,
      device_name: token.application&.name
    }
  end
...
Doorkeeper::Application.class_eval do
  has_many :rfid_readers, class_name: 'RfidReader', foreign_key: 'oauth_application_id'
  has_many :asset_tracking_events, foreign_key: 'oauth_application_id'
